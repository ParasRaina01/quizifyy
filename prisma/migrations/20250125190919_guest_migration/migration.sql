...
-- CreateIndex
CREATE INDEX "Game_guestSessionId_idx" ON "Game"("guestSessionId");
...
-- AddForeignKey
ALTER TABLE "Game" ADD CONSTRAINT "Game_guestSessionId_fkey" FOREIGN KEY ("guestSessionId") REFERENCES "GuestSession"("id") ON DELETE SET NULL ON UPDATE CASCADE;
